  ...
  namespace Applications {
    namespace Screens {
      ...
      private:
        ...
        Controllers::FS* fs;
        void openFile(lv_obj_t* item);
        void deleteFile(lv_obj_t* item);
        void showMenu(const char* title, lv_obj_t* item, bool image = false);
        void closeMenu();
        static void fileEventHandler(lv_obj_t* item, lv_event_t event);
        lv_obj_t* image = NULL;
