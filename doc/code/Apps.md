...
System::SystemTask::displayApp->StartApp(Apps::MyApp);  // old but working method to use constant arguments
System::SystemTask::displayApp->StartApp(new MyApp(/* arguments */);  // new method to use different arguments
```
